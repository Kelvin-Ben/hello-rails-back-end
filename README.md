...
**Hello-Rails-back-end** is a Rails API app that has Postgresql database setup with table for storing messages. It has an API endpoint that selects a random greeting from table
...
> Here the main goal of building this Rails App to have an understanding of the API endpoints.

- **[Create an API controller to hundle all api requests]**
- **[Use migration files]**
...
- [ ] **Fetch different greetings from an Api**
...
Feel free to check the [issues page](https://github.com/Kelvin-Ben/hello-rails-back-end/issues).
